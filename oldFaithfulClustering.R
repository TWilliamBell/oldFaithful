...
pdf("./DataVis/dbscanAttemptedClustering.pdf")
...
pdf("./DataVis/dbscanBasedClusteringForOldFaithful.pdf")

plot(oldFaithful[ , c(1,3)], col = colours()[dbscanGeyser$cluster+60], main = "Clustering according to DBSCAN of Old Faithful", xlab = "Eruption Length (min)", ylab = "Wait Time since Previous Eruption (hrs)")
...
pdf("./DataVis/kMeansOldFaithful.pdf")
